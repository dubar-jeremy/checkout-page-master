window.onload = function() {
  ...
  const bag = document.querySelector(".plus").addEventListener("click", increase);
  const bag = document.querySelector(".minus").addEventListener("click", decrease);
  const shoes = document.querySelector(".plusShoes").addEventListener("click", increase);
  const shoes = document.querySelector(".minusShoes").addEventListener("click", decrease);
